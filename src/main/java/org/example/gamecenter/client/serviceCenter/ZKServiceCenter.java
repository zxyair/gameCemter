...
import org.example.gamecenter.client.cache.ServiceCache;
import org.example.gamecenter.client.serviceCenter.ZkWatcher.watchZK;
import org.example.gamecenter.client.serviceCenter.banlance.impl.ConsistencyHashBanlance;
...
public class ZKServiceCenter implements ServiceCenter{
    ...
    public ZKServiceCenter() throws InterruptedException {
        ...
        this.client = CuratorFrameworkFactory.builder()
                .connectString("21.91.168.98:2181").sessionTimeoutMs(40000)
...
//                    new ConsistencyHashBanlance().banlance(serviceAddress);
            List<String> serviceAddress = client.getChildren().forPath("/" + serviceName);
            if (serviceAddress == null || serviceAddress.isEmpty()) {
                throw new IllegalStateException("未找到可用服务实例: " + serviceName);
            }
            String string = new ConsistencyHashBanlance().banlance(serviceAddress);
